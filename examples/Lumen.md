```php
  ...
  <?php
    ...
    use Hubtel\USSD\Request as USSDRequest; //Alias to prevent name collision with Lumen's Request
    ...
    /**
     * In this example we use to toArray because Lumen converts all array responses to Json.
